    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row align-items-start">
                <div class="col-9"><h1>Centro De Pagos</h1>
                    <%Date todayDate = new Date();
                        SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd");
                        String fecha = sdf.format(todayDate);%>
                    <b>
                        <label>Fecha Hoy: <%=fecha%></label> </b> <br><!-- comment -->
                    <label>Esta es la pestaña icinial. !</label><br>
                    <label>En esta pestaña puedes realizar pagos o realizar abonos de acuerdo a tu necesidad.</label>
                </div>
                ...
                <div class="col-3 align-self-center">
                    <div class="d-grid gap-2">
                        ...
                        %>
                        <label>Items Pendientes De Pago: </label>
                ...
                <table class="table table-striped" id="mydataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-success btnEditar" data-bs-toggle="modal" data-bs-target="#exampleModal">Abonar</button>
                                <a class="btn btn-info" href="Control?menu=Gasto&accion=Pagado&id=<%= elem.getId()%>">Pagar</a>
                            </td>
                        </tr>
                        <%
                            }
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="Control?menu=Gasto"  method="POST" role="form">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <input type="submit" name="accion" value="Realizar Abono" class="btn btn-success">
